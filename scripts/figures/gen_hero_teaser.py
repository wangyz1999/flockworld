...
Usage
-----
    python -m scripts.figures.gen_hero_teaser                                  # the README teaser
    python -m scripts.figures.gen_hero_teaser frame=210                        # a different instant
    python -m scripts.figures.gen_hero_teaser video=docs/media/rollout_floor.mp4
    python -m scripts.figures.gen_hero_teaser trail=0 out=output/figures/teaser_flat
"""
