...
Usage:
  uv run python -m scripts.analysis.probe_action_sensitivity --include exp08_tiled_two_stage \
      --episodes 4 --seconds 10
  uv run python -m scripts.analysis.probe_action_sensitivity --include exp01_baseline exp06_tiled_df \
...
from modeling.eval.multi import _decode_detect, _gt_positions, _load_model, _num_camera_agents
