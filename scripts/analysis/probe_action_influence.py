...
the model obeys the command. Output effect is scripts/analysis/probe_action_sensitivity.py; command
appropriateness is scripts/analysis/probe_command_coherence.py.

Usage:
  uv run python -m scripts.analysis.probe_action_influence --include exp01_baseline exp08_tiled_two_stage
"""
...
from modeling.eval.multi import _load_model
