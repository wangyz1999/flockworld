...
Diagnostic 1 (scripts/analysis/probe_action_sensitivity.py) asks whether the model RESPONDS to the action.
...
Usage:
  uv run python -m scripts.analysis.probe_command_coherence --include exp08_tiled_two_stage \
