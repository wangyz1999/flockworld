"""Follow-up to scripts/diagnostics/diagnose_identity.py: WHERE is diffusion-forcing's colored-boid
...
Usage:
  uv run python -m scripts.diagnostics.diagnose_identity_breakdown --include exp01_baseline exp03_diffusion_forcing
"""
...
from modeling.eval.experiments import EXPERIMENTS
