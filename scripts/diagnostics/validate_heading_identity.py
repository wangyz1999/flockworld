...
purely a validation step (mirrors scripts/diagnostics/validate_heading_detect.py), not part of the
...
imply agent b's true world position, frame by frame?
    ...
    uv run python -m scripts.diagnostics.validate_heading_identity
"""
