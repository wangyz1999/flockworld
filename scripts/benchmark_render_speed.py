...
Examples
--------
    python scripts/benchmark_render_speed.py --frames 120
    python scripts/benchmark_render_speed.py --devices cpu,gpu --agents 100,500,1500
    python scripts/benchmark_render_speed.py --frames 60 canvas.width=512 canvas.height=512
"""
