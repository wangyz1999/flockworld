...
Usage
-----
    python gen_env_variant_grid.py                       # frame 300 after warmup
    python gen_env_variant_grid.py step=500 seed=7       # pick a different moment
    python gen_env_variant_grid.py out_dir=output/figs
"""
