...
Usage:
  uv run python -m modeling.cli.compare_experiments --include exp01_baseline exp02_tiled
  uv run python -m modeling.cli.compare_experiments --include exp01_baseline exp02_tiled \
...
from modeling.eval.experiments import EXPERIMENTS, FLOOR_CONFIG, FLOOR_OUTPUT_DIR, RUN_ROOT
...
def main():
    ...
    if args.save_json or args.save_csv:
        ...
        if args.save_csv:
            from modeling.eval.multi import write_metrics_csv
