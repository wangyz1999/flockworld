...
Usage
-----
    python gen_env_figure.py step=240 focal=9         # the paper figure
    python gen_env_figure.py frustum=none             # crop boxes, no callout lines
    python gen_env_figure.py mark_future_work=true    # tag the gradient row as untrained
    python gen_env_figure.py out=paper/figures/env_conditions
"""
